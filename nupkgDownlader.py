...
parser = argparse.ArgumentParser(description="A simple CLI tool to download NuGet packages (.nupkg) and their dependencies.")

parser.add_argument("--package", "-p", type=str, required=True, help="Name of the package to download")
parser.add_argument("--version", "-v", type=str, required=True, help="Version of the package")
parser.add_argument("--output-folder", "-o", type=str, help="Folder to store the downloaded nupkg files (default: downloaded_packages_<package_name>_<version>)")

args = parser.parse_args()

if not args.output_folder:
    args.output_folder = f"downloaded_packages_{args.package}_{args.version}"
...
def get_all_dependencies(package_name, package_version):
    ...
    print(f"\n************** Checking for  {package_name} {package_version} **************")
